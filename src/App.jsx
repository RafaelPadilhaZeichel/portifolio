...
// --- Lista de Tecnologias para o Marquee ---
const techStack = [
          ...
          <div className="relative z-10 max-w-3xl mt-4 md:mt-0 order-2 md:order-1">
            <motion.div initial={{ x: -50, opacity: 0 }} animate={{ x: 0, opacity: 1 }} transition={{ duration: 1 }}>
              ...
              <h1 className="text-6xl md:text-9xl font-extrabold leading-[0.9] mb-6">
                RAFAEL <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#ccff00] via-emerald-400 to-[#ccff00] animate-gradient">PADILHA</span>
              </h1>
            </motion.div>
          ...
          {[...Array(4)].map((_, i) => (
            <React.Fragment key={i}>
              {techStack.map((tech, index) => (
                <div key={index} className="flex items-center gap-3 px-6 py-3 rounded-full border border-white/10 bg-white/5 backdrop-blur-sm text-gray-300 hover:border-[#ccff00] hover:text-[#ccff00] hover:bg-[#ccff00]/10 transition-all cursor-default">
                  {tech.icon}
        ...
        <div className="flex flex-col md:flex-row items-center gap-16 max-w-7xl mx-auto w-full">
          <div className="md:w-1/2 relative z-10">
            ...
            <p className="text-xl leading-relaxed text-gray-400 mb-6">
              Minha base em <strong className="text-[#ccff00]">SAP ABAP</strong> me ensinou a lidar com sistemas críticos onde o erro não é uma opção. Agora, aplico essa solidez no desenvolvimento Web.
            </p>
            <div className="grid grid-cols-2 gap-6 mt-10">
              <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ delay: 0.2 }} className="bg-white/5 p-6 rounded-xl border border-white/10 hover:border-[#ccff00] transition-colors">
                <Code className="mb-2 text-[#ccff00]"/>
                <h3 className="font-bold">Frontend</h3>
                <p className="text-sm text-gray-500">React, Vite, Tailwind</p>
              </motion.div>
              <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ delay: 0.4 }} className="bg-white/5 p-6 rounded-xl border border-white/10 hover:border-[#ccff00] transition-colors">
          ...
          <div className="md:w-1/2 flex justify-center md:justify-end w-full">
             <motion.div initial={{ opacity: 0, scale: 0.9 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} className="w-full max-w-md bg-black border border-white/10 p-10 rounded-3xl shadow-2xl relative overflow-hidden group">
               ...
               <p className="text-lg text-gray-300">Pronto para transformar requisitos complexos em experiências digitais fluidas.</p>
             </motion.div>
          </div>
        </div>
      </Section>
      ...
      <section id="contact" className="relative z-10 bg-gradient-to-b from-[#0a0a0a] to-[#111] border-t border-white/5 pt-20 flex flex-col justify-between min-h-[80vh]">
        <div className="w-full max-w-4xl mx-auto text-center px-6 flex-grow flex flex-col justify-center">
          ...
          <div className="flex flex-col md:flex-row justify-center gap-6 mb-20">
            ...
            <motion.a whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} href="mailto:padilharafael17@gmail.com" className="border border-white/20 bg-white/5 text-white px-10 py-5 rounded-full text-lg font-bold hover:bg-white hover:text-black transition-all flex items-center justify-center gap-2"><Mail size={24}/> Enviar E-mail</motion.a>
          </div>
        </div>
        <div className="w-full p-8 border-t border-white/5 bg-black mt-auto">
          <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center md:items-end gap-6">
            <div className="text-center md:text-left"><p className="font-bold text-lg text-white">RPZ.</p><p className="text-sm text-gray-500">Rafael Padilha © 2026</p></div>
